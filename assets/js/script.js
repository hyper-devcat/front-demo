...
// Scripts formulaire Réservation
...
$("#modal_chambre_deluxe").on('shown.bs.modal', function () {
    $('#input_modal_deluxe').trigger('focus')
  });

$("#modal_chambre_confort").on('shown.bs.modal', function () {
    $('#input_modal_confort').trigger('focus')
  });

$("#modal_chambre_classique").on('shown.bs.modal', function () {
    $('#input_modal_classique').trigger('focus')
  });

$("#modal_chambre_suite").on('shown.bs.modal', function () {
    $('#input_modal_suite').trigger('focus')
  });
